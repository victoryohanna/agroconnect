      ...
      <div className='header-text-section'>
        <div className='header-text'>
          ...
          <div className='header-context-section'>
              <p>  A digital market solution that bring farmers and buyers together. 
            </p>
            <p>Creating value for farmers and cunsumers for substainable growth and development</p>
          </div>
